...
<html lang="zh">
    <head>
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/editor/examples/css/style.css" />
...
```
        ...
        <script src="${pageContext.request.contextPath}/editor/editormd.min.js"></script>
